...
<style>
  :root { --ink:#1c2530; --muted:#5b6b7b; --line:#d7dee6; --bg:#f4f6f9; --card:#fff;
          --accent:#2f4a63; --pill:#eef2f6; --hl:#fde68a; --spark:#2f4a63; }
  * { box-sizing:border-box; }
  ...
  table.q th, table.q td { padding:7px 8px; border-bottom:1px solid #eef1f4; text-align:right;
  ...
  .ov.on { display:flex; }
  .modal { background:#fff; border-radius:10px; max-width:640px; width:100%; padding:20px; max-height:84vh; overflow:auto; }
